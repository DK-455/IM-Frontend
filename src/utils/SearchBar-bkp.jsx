...
//     updatedSelection[index] = selectedOption ? selectedOption.value : "";
...
//           {[0, 1, 2].map((index) => (
//             <div key={index} className="mx-2" style={{ width: "200px" }}>
//               <Select
...
//                 }))}
//                 value={projects
//                   .filter((project) => project.id === selectedProjects[index])
//                   .map((project) => ({
//                     value: project.id,
//                     label: project.name,
//                   }))}
